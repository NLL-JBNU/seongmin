...
if __name__ == '__main__':
    ...
    tgt_lines = []
    f = open(args.testfile + '_tgt_morph.txt', 'r', encoding="utf-8-sig")
    for line in f:
    ...
    for src_line, tgt_line in tqdm(zip(src_lines, tgt_lines), total=len(src_lines)):
        ...
        encoder_input_id = src_tokenizer.encode(src_line) 
        encoder_input_id.insert(0, src_tokenizer.index("<len>"))
